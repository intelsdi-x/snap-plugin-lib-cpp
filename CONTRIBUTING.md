...
* Whether your contribution is for a bug fix or a feature request, **create an [Issue](https://github.com/intelsdi-x/snap-plugin-lib-cpp/issues)** and let us know what you are thinking.
...
$ git clone https://github.com/intelsdi-x/snap-plugin-lib-cpp.git
    ```
...
Have you written a blog post about how you use [Snap](http://github.com/intelsdi-x/snap) and/or this library? Send it to us [on Slack](http://slack.snap-telemetry.io)!
